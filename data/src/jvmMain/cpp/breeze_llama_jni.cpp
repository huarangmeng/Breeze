...
Java_com_hrm_breeze_data_llm_ondevice_BreezeLlamaNativeBridge_nativeLoadModel(
    JNIEnv * env,
    jobject,
    jstring model_path,
    jint context_window
...
Java_com_hrm_breeze_data_llm_ondevice_BreezeLlamaNativeBridge_nativeUnload(
    JNIEnv *,
    jobject,
    jlong handle
) {
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_hrm_breeze_data_llm_ondevice_BreezeLlamaNativeBridge_nativeGenerate(
    JNIEnv * env,
    jobject,
...
extern "C" JNIEXPORT void JNICALL
Java_com_hrm_breeze_data_llm_ondevice_BreezeLlamaNativeBridge_nativeCancel(
    JNIEnv * env,
    jobject,
    jlong handle
) {
