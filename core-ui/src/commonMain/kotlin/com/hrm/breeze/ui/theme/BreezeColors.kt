...
data class BreezeExtendedColors(
    ...
    val appShellBackground: Color,
    val sidebarBackground: Color,
    val sidebarSelectedBackground: Color,
    val composerBackground: Color,
    val promptChipBackground: Color,
    val focusRing: Color,
...
internal val LightBreezeExtendedColors = BreezeExtendedColors(
    ...
    appShellBackground = Color(0xFFF7F9FC),
    sidebarBackground = Color(0xFFF0F3F7),
    sidebarSelectedBackground = Color(0xFFFFFFFF),
    composerBackground = Color(0xFFFFFFFF),
    promptChipBackground = Color(0xFFF3F5F7),
    focusRing = Color(0xFFB7D8FF),
...
internal val DarkBreezeExtendedColors = BreezeExtendedColors(
    ...
    appShellBackground = Color(0xFF0F1419),
    sidebarBackground = Color(0xFF171D24),
    sidebarSelectedBackground = Color(0xFF202832),
    composerBackground = Color(0xFF1A1F25),
    promptChipBackground = Color(0xFF202832),
    focusRing = Color(0xFF2E78C7),
