    ...
    object : OnDeviceRuntimeBridge {
        override val capability =
            unsupportedLlamaCapability(
                reason = "llama.cpp runtime is not implemented on Android yet",
                family = com.hrm.breeze.runtime.api.OnDeviceRuntimeFamily.AndroidJni,
                targetPlatforms = setOf(com.hrm.breeze.runtime.api.OnDeviceRuntimeTargetPlatform.Android),
